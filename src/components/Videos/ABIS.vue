<template>
  <div ref="videoContainer" class="relative h-full min-h-96 pointer-events-none select-none">
    <iframe
      src="https://streamable.com/e/n1qj85?autoplay=1&muted=1&loop=1"
    ...
    <button
      ...
      :aria-label="isFullscreen ? 'Exit Advanced Biometric Identification System fullscreen video' : 'Open Advanced Biometric Identification System video in fullscreen'"
