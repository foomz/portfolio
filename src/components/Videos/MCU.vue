<template>
  <div ref="videoContainer" class="relative h-full min-h-96 pointer-events-none select-none">
    <iframe
      src="https://streamable.com/e/x9xayi?autoplay=1"
    ...
    <button
      ...
      :aria-label="isFullscreen ? 'Exit MCU AI Chatbot fullscreen video' : 'Open MCU AI Chatbot video in fullscreen'"
    ...
    <div class="absolute bottom-2 left-2 right-2 bg-black bg-opacity-60 text-white text-xs p-2 rounded pointer-events-auto select-text z-10">
      This demo video is for AI-Powered Educational Technology project, showcasing the Manila Central University AI Chatbot Assistant.
    </div>
  </div>
</template>
