<template>
  <div ref="videoContainer" class="relative h-full min-h-96 pointer-events-none select-none">
    <iframe
      src="https://streamable.com/e/j4p2ey?autoplay=1&muted=1&loop=1"
    ...
    <button
      ...
      :aria-label="isFullscreen ? 'Exit DocTracker fullscreen video' : 'Open DocTracker video in fullscreen'"
