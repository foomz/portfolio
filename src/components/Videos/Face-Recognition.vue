<template>
  <div ref="videoContainer" class="relative h-full min-h-96 pointer-events-none select-none">
    <iframe
      src="https://streamable.com/e/xpw55f?autoplay=1&muted=1"
    ...
    <button
      ...
      :aria-label="isFullscreen ? 'Exit Face Recognition fullscreen video' : 'Open Face Recognition video in fullscreen'"
