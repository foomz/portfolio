<template>
  <section class="py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden" id="experience">
    <!-- Video Background -->
    <video 
      autoplay 
      loop 
    ...
    >
      <source src="/WorkExperienceVid.mp4" type="video/mp4">
    </video>
    ...
    <div class="relative z-10">
      ...
      <!-- Timeline Container -->
      <div class="max-w-6xl mx-auto relative px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative flex items-center mb-8 sm:mb-12 lg:mb-16"
             v-motion
          ...
          <!-- Content Card -->
          <div class="w-full md:w-5/12 ml-12 sm:ml-16 md:ml-0 md:mr-8">
            <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl p-4 sm:p-6 lg:p-8 shadow-2xl border border-gray-200 dark:border-gray-700 hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 transform">
              ...
              <div class="mb-6">
                <div class="flex items-center mb-4">
                  <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 overflow-hidden">
        ...
        <div class="relative flex items-center md:flex-row-reverse mb-8 sm:mb-12 lg:mb-16"
          ...
          <!-- Content Card -->
          <div class="w-full md:w-5/12 ml-12 sm:ml-16 md:ml-8 md:mr-0 relative">
            <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl p-4 sm:p-6 lg:p-8 shadow-2xl border border-gray-200 dark:border-gray-700 hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 transform">
              ...
              <div class="hidden md:block absolute -center-0 -right-52 z-30 flex flex-col space-y-8">
                <img src="/WorkExperienceImages/Me1.jpg" alt="NBI Work Experience" width="150" height="150" class="w-50 h-50 lg:w-50 lg:h-50 rounded-full object-cover border-4 border-white dark:border-gray-800 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 transform" />
                <img src="/WorkExperienceImages/Me2.jpg" alt="NBI Work Experience" width="120" height="120" class="w-50 h-50 lg:w-50 lg:h-50 rounded-full object-cover border-4 border-white dark:border-gray-800 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 transform" />
                <img src="/WorkExperienceImages/Me3.jpg" alt="NBI Work Experience" width="120" height="120" class="w-50 h-50 lg:w-50 lg:h-50 rounded-full object-cover border-4 border-white dark:border-gray-800 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 transform" />
                <img src="/WorkExperienceImages/Me4.jpg" alt="NBI Work Experience" width="120" height="120" class="w-50 h-50 lg:w-50 lg:h-50 rounded-full object-cover border-4 border-white dark:border-gray-800 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 transform" />
                <img src="/WorkExperienceImages/Me5.jpg" alt="NBI Work Experience" width="120" height="120" class="w-50 h-50 lg:w-50 lg:h-50 rounded-full object-cover border-4 border-white dark:border-gray-800 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 transform" />
                <img src="/WorkExperienceImages/Me6.jpg" alt="NBI Work Experience" width="120" height="120" class="w-50 h-50 lg:w-50 lg:h-50 rounded-full object-cover border-4 border-white dark:border-gray-800 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 transform" />
              </div>

              <!-- Company Header -->
              <div class="mb-6">
                <div class="flex items-center mb-4">
                  <div class="w-15 h-20 sm:w-15 sm:h-20 rounded-full flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 overflow-hidden">
