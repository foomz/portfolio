<template>
  <div class="min-h-screen bg-gray-200 dark:bg-gray-900 transition-colors duration-300">
    ...
    <main class="pt-16">
      <!-- Hero Section -->
      <section class="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-600 to-purple-700 dark:from-blue-800 dark:to-purple-900 py-20">
        ...
        <div class="text-center text-white mb-16"
          ...
          <div class="flex flex-col items-center">
            <div class="w-48 h-48 rounded-full overflow-hidden border-4 border-white dark:border-gray-300 shadow-lg mb-8"
                 v-motion
              ...
              <img src="https://i.imgur.com/Vbx10VA.png" alt="Johnray M. De Luna" class="w-full h-full object-cover">
            </div>
            <h1 class="text-4xl md:text-6xl font-bold mb-4">Johnray M. De Luna</h1>
            <p class="text-xl md:text-2xl">Cybersecurity Professional & Full Stack Developer</p>
          </div>
        </div>
        ...
        <div class="flex justify-center space-x-6"
             ...
             :enter="{ x: 0, opacity: 1 }"
             :delay="400">
          <a href="mailto:jdeluna@nbi.gov.ph" 
             class="flex items-center space-x-2 text-white hover:text-blue-200 transition-colors">
            <EnvelopeIcon class="h-6 w-6" />
            <span>Email</span>
          </a>
          <a href="https://facebook.com/Foomz.Cuteness" 
             target="_blank" 
             class="flex items-center space-x-2 text-white hover:text-blue-200 transition-colors">
          ...
          <a href="https://linkedin.com/in/johnraydeluna" 
             target="_blank" 
             class="flex items-center space-x-2 text-white hover:text-blue-200 transition-colors">
            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Experience Section -->
        <section class="py-20 px-4 bg-white dark:bg-gray-800 transition-colors duration-300" id="experience">
          ...
          <div class="max-w-7xl mx-auto space-y-12">
            <div class="bg-gray-50 dark:bg-gray-700 p-8 rounded-lg shadow-md"
                 ...
                 :visible="{ scale: 1, opacity: 1, transition: { duration: 1000 } }">
              <div class="mb-6"
                   v-motion
                   :initial="{ x: -50, opacity: 0 }"
                   :visible="{ x: 0, opacity: 1, transition: { duration: 800, delay: 200 } }">
                <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-2">NATIONAL BUREAU OF INVESTIGATION</h3>
                <h4 class="text-xl font-semibold text-blue-600 dark:text-blue-400">Project Worker</h4>
              </div>
              ...
              <div class="space-y-8">
                <div v-for="(position, index) in experience"
                  ...
                  <div class="mb-4 hover:translate-x-2 transition-transform duration-300">
                    <p class="text-gray-700 dark:text-gray-300 text-lg mb-1">{{ position.department }}</p>
                    <p class="text-blue-600 dark:text-blue-400">{{ position.period }}</p>
                  </div>
  
                  <div class="space-y-3">
                    <p v-for="(duty, dutyIndex) in position.duties" 
                       :key="dutyIndex"
                       class="text-gray-700 dark:text-gray-300 leading-relaxed pl-4 relative before:content-['•'] before:absolute before:left-0 before:text-blue-600 dark:before:text-blue-400"
                       v-motion
                       ...
                       :visible="{ 
                         ...
                         transition: { 
                           duration: 600, 
                           delay: 400 + (index * 200) + (dutyIndex * 100) 
                         } 
                       }">
                      {{ duty }}
                  </p>
                ...
                <div v-if="position.department.includes('Regional District Offices')" 
                ...
                <div v-if="position.department.includes('Technology Infrastructure Division')" 
                     class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"
                     v-motion
                     :initial="{ y: 50, opacity: 0 }"
                     :visible="{ y: 0, opacity: 1, transition: { duration: 800 } }">
                ...
                <!-- Photo Gallery for Cybercrime Division -->
                <div v-if="position.department.includes('Cybercrime Division')" 
                     class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"
                     v-motion
                     :initial="{ y: 50, opacity: 0 }"
                     :visible="{ y: 0, opacity: 1, transition: { duration: 800 } }">
                ...
                <div v-if="position.department.includes('Digital Forensics Laboratory')" 
                     class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"
                     v-motion
                     :initial="{ y: 50, opacity: 0 }"
                     :visible="{ y: 0, opacity: 1, transition: { duration: 800 } }">
      ...
      <!-- Skills Section -->
      <section class="py-20 px-4 bg-gray-100 dark:bg-gray-900 transition-colors duration-300" id="skills">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div v-for="(category, index) in skills"
                 ...
                 :visible="{ y: 0, opacity: 1 }"
                 :delay="index * 200">
              <h3 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">{{ category.title }}</h3>
              <div class="space-y-2">
                <div v-for="(subcategory, subIndex) in category.items" 
                     :key="subIndex"
                     class="mb-3">
                  <h4 v-if="subcategory.title" class="font-semibold text-blue-600 dark:text-blue-400 mb-2">
                    {{ subcategory.title }}:
                  </h4>
                  <div class="flex flex-wrap gap-2">
                    <span v-for="skill in subcategory.skills" 
                          :key="skill"
      ...
      <!-- Projects Section -->
      <section class="py-20 px-4 bg-white dark:bg-gray-800 transition-colors duration-300" id="projects">
        <div class="max-w-7xl mx-auto">
          <h2 class="text-3xl font-bold mb-12 text-center text-gray-900 dark:text-white"
              v-motion
              :initial="{ y: 50, opacity: 0 }"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div v-for="(project, index) in projects"
                 :key="project.title"
                 class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md transform transition-all duration-500 hover:scale-105"
                 v-motion
                 :initial="{ x: index % 2 === 0 ? -100 : 100, opacity: 0 }"
    ...
    <footer class="bg-gray-800 dark:bg-gray-900 text-white py-8">
      <div class="max-w-7xl mx-auto px-4 text-center">
        ...
        <p class="text-gray-300">© 2025 Johnray M. De Luna. All rights reserved.</p>
      </div>
    </footer>
  </div>
</template>
...
import { EnvelopeIcon, SunIcon, MoonIcon } from '@heroicons/vue/24/outline'
import { trackVisitor } from './utils/geolocation'
    ...
    photos: [
      {
        ...
        description: 'HackRF One on Rasberry Pi - Simple IMSI Catche Experiment'
      },
      {
    ...
    items: [
      {
        ...
        skills: ['HTML', 'CSS', 'Javascript', 'Typescript', 'PHP', 'SQL', 'Python', 'Git', 'Github', 'Responsive Design']
      },
      {
        title: 'Front-end Frameworks',
        skills: ['React', 'Vue', 'Next', 'Vite', 'Svelte', 'Tailwind']
      },
      {
        title: 'Back-end Frameworks',
        skills: ['Node.js', 'Django', 'Sqlite', 'Mysql', 'MSSQL Server', 'REST API']
      },
      {
        title: 'DevOps & Tools',
        skills: ['Command Line', 'Basic UI/UX', 'Testing', 'Debug', 'Security Practice', 'CI/CD', 'AWS', 'GCP', 'Linode', 'Containerization']
      }
    ]
  },
  {
    ...
    items: [
      {
        title: 'Core Skills',
        skills: ['Python', 'Bash', 'Networking', 'Web App Security', 'IDS', 'IPS', 'Firewall', 'Linux']
      },
      {
        title: 'Security Testing',
        skills: ['SQLI', 'XSS', 'CSRF', 'LFI', 'WAF', 'API EndPoints', 'VAPT']
      },
      {
        title: 'Security Operations',
        skills: ['Security Tools', 'Analytical Skills', 'Social Engineering', 'OSINT', 'Reconnaissance', 'Malware Analysis']
      },
      {
        title: 'Governance',
        skills: ['Security Policies', 'Forensics', 'Security Audit', 'Risk Management']
      }
    ]
  },
  {
...
const projects = [
  {
    ...
    description: 'This project helps centralize document management, ensuring consistency and improving decision-making through trend analysis. It enhances efficiency by streamlining data entry and automating calculations, while fostering accountability with audit trails and progress monitoring. The scalable design allows for easy expansion and integration, and a responsive interface improves accessibility. Additionally, OCR technology automates data extraction, reduces errors, and creates searchable digital records, promoting a more efficient, transparent, and data-driven operational environment.',
    link: 'https://invs-ocr-document-tracking.vercel.app'
  },
  {
    title: 'Human Resource Management',
    description: 'This project is a web application built using React for the frontend and Django for the backend. It provides a login system and various HR-related functionalities such as employee management, attendance tracking, recruiting, onboarding, payroll management, and more.',
    link: 'https://human-resource-management-alpha.vercel.app'
  },
  {
    title: 'Network Web Mapper',
    description: 'A Project for my Portfolio. A Web Based Network Mapper that uses reconnaissance to gather information on ip address and domains made by reactJS and Django.',
    link: 'https://network-web-mapper.vercel.app'
  },
  {
    title: 'Simple Current App',
    description: 'A simple currency converter application built with Svelte and TypeScript. This application fetches real-time exchange rates and allows users to convert amounts between different currencies.',
